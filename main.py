...
if __name__ == '__main__':
    ...
    add_dataset_to_knowledge_base_json('dataset.json', load_knowledge_base('knowledge_base.json'))
    add_dataset_to_knowledge_base_json('rldataset.json', load_knowledge_base('knowledge_base.json'))
    add_dataset_to_knowledge_base_json('familyproblemtest.json', load_knowledge_base('knowledge_base.json'))
    # Start the chat bot
    chat_bot()
